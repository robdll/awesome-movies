...
function Movie({item, idx, cb1, cb2}) {
  ...
  const actionsCell = <div className={styles.actions}>
    <img onClick={()=>cb1(item)} className={styles.svg} src="/awesome-movies/star.svg" alt="favorite icon" />
    <img onClick={()=>cb2(item)} className={styles.svg} src="/awesome-movies/watchLater.svg" alt="watchLater icon" />
  </div>
